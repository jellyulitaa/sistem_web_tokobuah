                ...
                <div class="col-md-6 col-lg-3">
                    <div class="p-4 text-center rounded featurs-item bg-light">
                        ...
                        <div class="text-center featurs-content">
                            <h5>Free Shipping</h5>
                            <p class="mb-0">Free on order over RP300K</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
